...
В приведенном примере мы видим два представления для класса Order (E- и L-представление). Откроем на редактирование **представление для списковой формы** (OrderL) (выберем в строке с OrderL ячейку в столбце Properties и нажмём кнопку [ … ], появившуюся справа):
